...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-row mb-2">
            ...
            <div class="form-group col-md-2 filter-btn col-md-1 text-right" style="margin-top: 30px;">
                <button type="button" id="button-filter" class="btn btn-danger"><i class="fa fa-filter"></i>&nbsp;Filter</button>
                <button type="button" id="reset-filter" class="btn btn-danger"><i class="fa fa-filter"></i>&nbsp;Reset Filter</button>
            </div>
        </div>
                    ...
                    @foreach($lead_users as $key => $user)
                        <tr data-entry-id="{{ $user->id }}">
                            ...
                            <td>
                                ...
                                @endphp
                                <a  class="btn btn-xs btn-primary @if (!$button_enable) not-active @endif" href="{{ route('admin.leads.show', $user->id) }}">
                                    {{ trans('global.view') }}
                                </a>  
                                @if($user->total > 1)   
                                <a class="btn btn-xs btn-primary" href="{{ route('admin.leads.show-all', $user->id) }}">
